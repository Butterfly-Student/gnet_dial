        ...
        <div class="flex md:items-center justify-between gap-3 sm:gap-4">
            <div>
                <h2 class="text-base sm:text-xl md:text-2xl font-bold text-gray-800 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        class="lucide lucide-activity mr-1.5 sm:mr-3 text-blue-600 w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7">
            ...
            <div class="flex items-center gap-2">
                ...
                <button id="refresh-btn"
                    class="bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2 rounded-lg transition-colors shadow-sm hover:shadow text-sm flex items-center gap-2">
    ...
    <div class="mb-4 border-b border-gray-200 bg-white rounded-t-xl px-4 pt-4">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="monitor-tabs" role="tablist">
            <li class="mr-2" role="presentation">
                <button
                    class="inline-block p-4 border-b-2 border-blue-600 rounded-t-lg active text-blue-600 hover:text-blue-600"
                    id="interfaces-tab" data-tabs-target="#interfaces" type="button" role="tab"
                    aria-controls="interfaces" aria-selected="true">
                    Interfaces (<span id="interface-count">0</span>)
                </button>
            </li>
            <li class="mr-2" role="presentation">
                <button
                    class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 text-gray-500"
                    id="queues-tab" data-tabs-target="#queues" type="button" role="tab" aria-controls="queues"
                    aria-selected="false">
        ...
        function startPolling() {
            ...
            checkMikrotikConnection().then(online => {
                if (online) {
                    ...
                    // Don't start polling if offline, just show error state if needed
                }
            });
        }
