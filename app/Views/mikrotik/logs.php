  ...
  <div class="bg-white rounded-lg sm:rounded-xl shadow-lg p-3 sm:p-4 md:p-6 mb-3 sm:mb-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4">
      ...
      <div class="flex items-center gap-2 sm:gap-3">
        <select id="log-limit" class="appearance-none bg-gray-50 border border-gray-300 text-gray-700 text-xs sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-3 py-2 sm:px-4 sm:py-2.5 outline-none transition-shadow cursor-pointer">
          <option value="50">50 Baris</option>
          <option value="100" selected>100 Baris</option>
          <option value="200">200 Baris</option>
          <option value="500">500 Baris</option>
        </select>
        <button id="refresh-logs" class="bg-blue-600 hover:bg-blue-700 text-white p-2 sm:p-2.5 rounded-lg transition-colors shadow-sm hover:shadow flex-shrink-0">
    ...
    <div class="mt-3 sm:mt-6 relative group">
      <div class="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-focus-within:text-blue-500 transition-colors"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
      </div>
      <input
        type="text"
        id="log-search"
        ...
        autocomplete="off">
      <div id="search-loading" class="absolute inset-y-0 right-0 pr-3 sm:pr-4 flex items-center pointer-events-none hidden">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-loader-2 animate-spin text-blue-500 w-4 h-4 sm:w-5 sm:h-5"><path d="M21 12a9 9 0 1 1-6.219-8.56"/></svg>
      </div>
    </div>
  </div>
