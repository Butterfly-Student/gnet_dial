...
try {
    ...
    // Check if it already exists to avoid error? name is dropped so it shouldn't conflict unless another index exists.
    // Let's just try adding it. If unique_name_mikrotik exists we can skip or drop/add.
    // Simple check:
